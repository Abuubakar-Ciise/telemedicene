...
class _DoctorLabRequestState extends State<DoctorLabRequest> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          buildTextField(c["test_name"]!, "Test Name", isRequired: true),
          const SizedBox(height: 12),
          buildTextField(c["description"]!, "Description"),
          const SizedBox(height: 12),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Lab Request", style: TextStyle(color: Colors.black)),
        centerTitle: true,
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                // Notes Section
                buildTextField(notes, "Additional Notes"),
